...
The hard part of using Git in RStudio is getting it set-up.

1. Telling RStudio where `git.exe` resides.
2. Telling RStudio how to communicate with GitHub.

Go to the [set-up instructions](set-up.html) and scroll down to the section on how to set-up RStudio with Git. Follow instructions carefully and slowly.
