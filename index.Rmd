...
The focus of these training sessions is practical skills and tools. To follow along with the GitHub workshop, go to [Set-up](set-up.html). No set-up is needed for the R packages workshop as we will use RStudio Cloud. Links to all the PSAW III Sessions is [here](https://sites.google.com/noaa.gov/nmfs-ost-psaw/home).

<hr>

## Intro to R Packages, and especially data R packages Feb 16

[Video of the workshop](https://youtu.be/DHoedjyRWfU)
