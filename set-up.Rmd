...
* You will need a GitHub (free) account. Sign up here [GitHub](https://github.com/). 

## Git GUI

To interact with GitHub, we need an interface. Options:

1. I will be showing [GitHub Desktop](https://desktop.github.com/), a simple interface that I recommend. Download that if you want to try it out.

2. You can also use RStudio Cloud (with a browser) instead of installing programs (or if you following along on a phone or tablet): Sign up for an [RStudio Cloud](https://rstudio.cloud/) account.
...
4. JupyterLab user (Python)? The [jupyter-git extension](https://github.com/jupyterlab/jupyterlab-git) is nice if you want to interact within JupyterLab.
